...
namespace NavisWorksInfoTools.S1NF0_SOFTWARE
{
    public class StructureDataStorage
    {
        ...
        public const string DEFAULT_CLASS_NAME = "Default";
        public const string DEFAULT_CLASS_NAME_IN_PLURAL = "Default";
        ...
        public StructureDataStorage(Document doc, string stPath, string clPath, Structure structure, Classifier classifier)
        {
            ...
            {
                DefClassWithNoProps = CreateNewClass(DEFAULT_CLASS_NAME, DEFAULT_CLASS_NAME_IN_PLURAL);
            }
        ...
        private void SurveyClass(Class @class)
        {
            ...
            if (!String.IsNullOrWhiteSpace(@class.Code))//Классы без кода останутся но не попадают в словари
            {
                ...
                else if (DefClassWithNoProps == null && @class.Name.Equals(DEFAULT_CLASS_NAME))
                {
        ...
        public XML.St.Object CreateNewContainerObject(XML.St.Object parent, string name)
        {
            ...
            {
                Name = name,
                ClassCode = DefClassWithNoProps.Code,
